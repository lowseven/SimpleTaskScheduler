...
{
    public interface ITaskScheduler<TData> : ITaskScheduler
    {
        /// <summary>
        ...
        void EnqueueWork(Func<TData> doWork, TaskCreationOptions creationOptions = TaskCreationOptions.None);
        /// <summary>
        /// Queueing a WorItem into the scheduler
        /// </summary>
        /// <param name="doWork">The work to be done</param>
        ...
        /// <param name="creationOptions">The optional creation options of the workItem</param>
        /// <param name="dueTime">The workitem timeout to complete the workItem</param>
        void EnqueueWork(Func<TData> doWork, Action<TData> doWorkCallback, TaskCreationOptions creationOptions = TaskCreationOptions.None);
        /// <summary>
        /// Queueing a WorItem into the scheduler
        /// </summary>
        ...
        /// <param name="creationOptions">The optional creation options of the workItem</param>
        /// </summary>
        bool TryExecuteItNow(Func<TData> doWork, TaskCreationOptions creationOptions = TaskCreationOptions.None);
        /// <summary>
        /// Determines whether the provided doWorkCallback can be executed 
        /// in this call, and if so, executes it.
        /// <param name="doWork">The work to be done</param>
        ...
        /// <param name="creationOptions">The optional creation options of the workItem</param>
        /// </summary>
        bool TryExecuteItNow(Func<TData> doWork, Action<TData> doWorkCallback = null, TaskCreationOptions creationOptions = TaskCreationOptions.None);
    }
    ...
    public interface ITaskScheduler : IDisposable
    {
        ...
        /// </summary>
        /// <param name="doWork">The work to be done</param>
        void EnqueueWork(Action doWork, TaskCreationOptions creationOptions = TaskCreationOptions.None);
        /// <summary>
        /// Queueing a callback as a workItem into the scheduler
        ...
        /// <param name="creationOptions">The optional creation options of the workItem</param>
        /// <param name="dueTime">The workitem timeout to complete the workItem</param>
        void EnqueueWork(Action doWork, Action doWorkCallback, TaskCreationOptions creationOptions = TaskCreationOptions.None);
        /// <summary>
        /// Queueing a WorItem into the scheduler
        /// </summary>
        /// <param name="work">the work to be executed</param>
        ...
        /// <param name="creationOptions">The optional creation options of the workItem</param>
        /// </summary>
        bool TryExecuteItNow(Action doWork, TaskCreationOptions creationOptions = TaskCreationOptions.None);
        /// <summary>
        /// Determines whether the provided doWorkCallback can be executed 
        /// in this call, and if so, executes it.
        /// <param name="doWork">The work to be executed</param>
        ...
        /// <param name="creationOptions">The optional creation options of the workItem</param>
        /// </summary>
        bool TryExecuteItNow(Action doWork, Action doWorkCallback, TaskCreationOptions creationOptions = TaskCreationOptions.None);
    }
}
